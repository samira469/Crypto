...
//  CryptoSample
//
//  Created by Samira Daneshyar on 10/30/16.
//  Copyright © 2016 Samira Daneshyar. All rights reserved.
//
...
public let _Instance = CryptoManager()


public let CryptoManagerApplicationTag = "com.samira.Apptag"
public let CryptoManagerKeyType = kSecAttrKeyTypeRSA
public let CryptoManagerKeySize = 2048
public let CryptoManagerCypheredBufferSize = 1024
public let CryptoManagerSecPadding: SecPadding = .PKCS1
...
public class CryptoManager: NSObject {
    ...
    public class var sharedInstance: CryptoManager {
        return _Instance
    }
    ...
    public func createSecureKeyPair(_ completion: ((_ success: Bool, _ error: CryptoException?) -> Void)? = nil) {
        ...
        let privateKeyParams: [String: AnyObject] = [
            ...
            kSecAttrApplicationTag as String: CryptoManagerApplicationTag as AnyObject
        ]
        ...
        let parameters: [String: AnyObject] = [
            kSecAttrKeyType as String:          CryptoManagerKeyType,
            kSecAttrKeySizeInBits as String:    CryptoManagerKeySize as AnyObject,
    ...
    public func getPublicKeyData() -> Data? {
        let parameters = [
            ...
            kSecAttrApplicationTag as String: CryptoManagerApplicationTag,
    ...
    public func decryptMessageWithPrivateKey(_ encryptedData: Data, completion: @escaping (_ success: Bool, _ result: String?, _ error: CryptoException?) -> Void) {
        DispatchQueue.global(qos: DispatchQoS.QoSClass.default).async { () -> Void in
            ...
            if let privateKeyRef = self.getPrivateKeyReference() {
                ...
                // prepare output data buffer
                var plainData = Data(count: CryptoManagerCypheredBufferSize)
